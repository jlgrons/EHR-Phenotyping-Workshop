...
In this workshop, we will introduce statistical learning methods designed to expedite the phenotyping process to improve the scalability of EHR research. 
...
We will use the real EHR data examples from [PheCAP](https://celehs.github.io/PheCAP/), an R package that implements high-throughput phenotyping with electronic health records (EHRs) using a common automated pipeline. 
